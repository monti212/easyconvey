...
export function getDeclarationOfPurchaserConfig(transactionBlock: string): DocumentConfig {
  return {
...
- Generate a COMPLETE Declaration of Purchaser exactly matching the formal format below
...
- For COMPANIES: The declaration is made by a Director. A Board Resolution and Affidavit of Shareholding must be appended.
...
[IF AND ONLY IF the purchaser is a COMPANY — append the Board Resolution and Affidavit of Shareholding pages as required by law.]`,
  };
}
